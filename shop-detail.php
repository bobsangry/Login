    ...
    <div class="shop-detail-box-main">
        <div class="container">
			...
			<?php if (isset($_SESSION['userId'])){
				  echo '<ul>
						...
						<div class="add-to-btn">
							<div class="add-comp">
								<a class="btn hvr-hover" href="#"><i class="fa fa-heartbeat"></i> Add to wishlist</a>
								<a class="btn hvr-hover" href="#"><i class="fa fa-map-signs"></i> Add to Compare</a>
							</div>
							<div class="share-bar">
			...
			echo '
						...
						<div class="price-box-bar">
							<div class="cart-and-bay-btn">
								<p>Sign in to order online</p>
							</div>
						</div>

						<div class="add-to-btn">
							<div class="add-comp">
								<p>Sign in to use wishlist</p>
								<p>Sign in to compare products</p>
							</div>
							<div class="share-bar">
								<a class="btn hvr-hover" href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
								<!-- <a class="btn hvr-hover" href="#"><i class="fa fa-google-plus" aria-hidden="true"></i></a> -->
			...
			<div class="row my-5">
				<div class="card card-outline-secondary my-4">
					...
					<div class="card-body">
						...
						<hr>
								<?php if (isset($_SESSION['userId'])){
			echo '<a href="#" class="btn hvr-hover">Leave a Review</a>';
		}
		else {
			
			echo '<p>Sign into an account to Leave a Review</p>';
		}
		?>
		</main>
        ...
        <div class="main-instagram owl-carousel owl-theme">
            <div class="item">
                <div class="ins-inner-box">
                    ...
                    <div class="hov-in">
                        <a href="#"><img src="images/fb_icon_325x325.png" alt=""></a>
                    </div>
                </div>
            </div>
            <div class="item">
